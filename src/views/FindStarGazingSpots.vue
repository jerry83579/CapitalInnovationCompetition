    <template>
      <div id="app">
        ...
        <v-main>
        <v-container fluid>
        <v-row style="background-color:#e5e5e5;" justify="center">
        ...
        <v-col cols="6">
        <v-card color="#f2cc8f">
        <v-card-title style="font-size:2rem">台中市</v-card-title>
        <v-divider class="mr-10"></v-divider>
        <v-card-title>台中市面積2,215平方公里，設籍人口約282萬人，為臺灣人口排名第二大城市，是臺灣第二大都會區「臺中都會區」的核心都市</v-card-title>
        <v-card-text>
        23&deg;C
        </v-card-text>
        </v-card>
