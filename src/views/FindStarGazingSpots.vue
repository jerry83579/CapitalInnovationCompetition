    <template>
      <div id="app">
        ...
        <v-main>
        <v-container fluid>
        <v-row style="background-color:#ffd166;" justify="center">
        <v-col class="mt-16 title text-center" style="font-size:4.2rem">
        <h2 data-aos="fade-down" data-aos-once="true"><v-icon>mdi-map-search</v-icon>找尋你想去的觀星景點</h2></v-col>
        </v-row>

        <v-row style="background-color:#81b29a;">
        <v-col cols="6">
        <v-card style="background: rgba(255,255,255,0.3);">
        <v-card-title style="font-size:2rem" id="text">台中市</v-card-title>
        <v-divider class="mr-10"></v-divider>
        <v-card-title>觀星景點:</v-card-title>
        <v-card-title id="textarea">大雪山國家森林遊樂區，武嶺，福壽山農場，都會公園</v-card-title>
        </v-card>
        </v-col>
        ...
        <v-col sm="6" >
        <svg id="svg" xmlns="http://www.w3.org/2000/svg"  xml:space="preserve" fill="white" >
        <!-- ======================= 基隆市  ======================= -->
        <g>
        <desc>基隆市區域</desc>
        <path id="C10017"  data-name="基隆市" @click="jumpPage('Keelung')" d="M315.9,53.9c1.1-0.7,4.2-1.7,7.7-3.2c0.2,0.4,0.4,0.7,0.7,0.9c1.3,1,4,3.1,7.9,4.3c1.2,2.3,0.3,3.6,0.7,6.3
        c0.4,2.9,0.6,4.4,0,6.4c-0.6,2.1-11.8-0.6-15.3-6C314,57.2,314.4,54.7,315.9,53.9z M371.8,12.4c0.9,2.2,4,2.5,7.1,2.5
        c3.1,0,0.3,2.5,9,2.5c8.7,0,8.7-2.5,4-5c-4.7-2.5-17.7-7.1-18.6-5.6C372.4,8.3,371.8,12.4,371.8,12.4z" ></path>
        </g>
        <!-- ======================= end 基隆市  ======================= -->
        <!-- ======================= 新北市  ======================= -->
        <a class="">
        <g>
        <desc>新北市區域</desc>
        <path id="C65" data-name="新北市" @click="jumpPage('Xinbei')" d="M361.5,72.3c-6.8-0.3-9,0.3-9.3-6.2c1.2-11.2-6.2-9.3-13.7-9.3c-2.4,0-4.5-0.4-6.4-1c1.2,2.3,0.3,3.6,0.7,6.3
        ...
        <!-- ======================= end 新北市  ======================= -->
        <!-- ======================= 台北市  ======================= -->
        <a xlink:href="javascript:void(0)" class="">
        <g>
        <desc>台北市區域</desc>
        <path id="C63" data-name="台北市" d="M317.1,71.5c1.2,4.1-2.5,2.9-4.1,3.9c-1.7,1,2.3,5.2,0,5.8c-7.7,0.4-8.1-3.1-11-5c-2.9-1.9-4.3-3.9-4.3-7
        c0-3-1.4-5.5-5.6-8.4c-4.1-2.9-2.9-5.2-0.8-5.6c2.1-0.4,15-8.2,16.4-8.7c1.4-0.5,2.7,1.9,1.9,3.7c-0.8,1.9,0.2,3.9,1,7.7
        ...
        <g>
        <desc>桃園市區域</desc>
        <path id="C68" data-name="桃園市" d="M287.8,135.2c-1.3,0.1-2.3-0.3-3.7-0.3c-1.9,0-4.1-3.3-5.4-5c-1.2-1.7-5.2-2.3-7.7-3.5c-2.5-1.2,0.4-5,1.7-8.1
        ...
        <g>
        <desc>新竹縣區域</desc>
        <path id="C10004" data-name="新竹縣" d="M275.1,157.9c-0.2,0-5.3,1.1-7.4,1.4c0-2-2.5-5.5-3.4-8.1c-1-2.9-2.7-4.4-4.3-5c-1.7-0.6-3.5,1.5-4.6,2.2
        ...
        <g>
                    <desc>新竹市區域</desc>
                    <path id="C10018" data-name="新竹市" d="M215.3,113.5c0.3-0.3,0.6-0.5,0.9-0.8c3.7-3.7,4-8.4,4-14c0-0.2,0-0.3,0-0.5c5.4,0.5,14.6,4.1,17.2,5.3
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>苗栗縣區域</desc>
                    <path id="C10005" data-name="苗栗縣" d="M182.3,154.3c0.6-1.1,1.6-1.8,3.4-1.8c2.2-0.3,2.5-5.9,3.7-9.3c1.2-3.4,1.6-11.2,6.5-11.5c5-0.3,3.4-3.7,5-5.6
                ...
                <a xlink:href="/taichung">  
                  <g>
                    <desc>台中市區域</desc>
                    <path id="C66" data-name="台中市" @click="jumpPage('Taichung')" d="M168.4,194.1c-2.1-0.6-3-1-3.9-1.4c3-4.8,6.1-10.3,6.3-12.2c0.3-3.4,5.3-15.2,8.4-18.6c2-2.2,1.9-5.5,3.1-7.5
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>南投縣區域</desc>
                    <path id="C10008" data-name="南投縣" d="M280.2,188.3c0.1,3.1-0.3,5.2-2.2,5.6c-2.7,0.6-5.8-0.4-5.8,3.5c0,3.9,2.3,6.4,4.2,7.7c2,1.2,1.7,4.6-0.2,6
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>彰化縣區域</desc>
                    <path id="C10007" data-name="彰化縣" d="M131.9,248c0.3-0.3,0.7-0.7,1-1c6.5-6.5,11.5-19.3,11.5-23.9c0-4.7,11.2-10.3,11.2-13c0-2.8,0.9-7.1,3.4-9.6
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>雲林縣區域</desc>
                    <path id="C10009" data-name="雲林縣" d="M131.9,293.8c5.4,0.4,2.5-6.4,3.9-5c1.5,1.5,4.6-0.2,5.2-2.1c0.6-1.9,0.6-2.7,2.9-2.5c2.3,0.2,2.3-0.6,2.3-2.5
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>嘉義縣區域</desc>
                    <path id="C10010" data-name="嘉義縣" d="M129.3,323.2c2.3-0.4,7.2-6.8,8.1-7.4c0.8-0.5,5.2-5.5,8.5-7.8c3.3-2.3,7.7-1.2,11-2.1c3.3-0.8,5.4,1,9.3,1.5
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>嘉義市區域</desc>
                    <path id="C10020" data-name="嘉義市" d="M151.8,294.8c0-1.7,3.2-3.1,7-3.5c3.8-0.4,4.6,0.4,7.1,1.8c2.5,1.3,6.6,4.9,5.2,5.9c-1.4,1-2.7,0.6-4.8,1.7
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>台南市區域</desc>
                    <path id="C67" data-name="台南市" d="M122.6,372c0.1-0.9,0.2-1.5,0.4-2c0.9-2.5,3.4-6.8,1.9-8.1c-1.6-1.2-5,1.2-5.6,3.7c-0.6,2.5-2.8-2.5-2.2-5.3
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>高雄市區域</desc>
                    <path id="C64" data-name="高雄市" d="M157.9,441.7c-0.1-0.1-0.1-0.2-0.2-0.2c-8.1-0.9-14.6-8.7-17.7-13.7c-3.1-5-9-9.6-7.5-11.5
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>屏東縣區域</desc>
                    <path id="C10013" data-name="屏東縣" d="M214.8,473.1c0.9,0.5,3.4,2.8,5.6,4.6c0.8,6.5,1.7,12.7,1.9,15.6c0.6,6.5,0.1,14.3-3.4,15.2
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g>
                    <desc>台東縣區域</desc>
                    <path id="C10014" data-name="台東縣" d="M296.6,302.5c0.9,0,1.8,0.1,2.6,0.2c-0.1,1-0.1,1.9-0.1,2.7c0,6.5-2.5,15.2-6.2,16.8
               ...
               c2-2.2,1.4-9-1.4-9.3c-2.8-0.3-8.7-2.2-5.9-3.4c2.8-1.2,2.5-9.9,0-11.3c-2.5-1.3-15-0.7-19,0C281.6,478.6,289.5,483.7,288.5,487.1z" style="stroke-dasharray: 690.556, 690.556; stroke-dashoffset: 0;"></path>
                ...
                <!-- =======================end 台東縣 ======================= -->
                <!-- ======================= 花蓮縣  ======================= -->
                <a xlink:href="javascript:void(0)" class="is-active">
                  <g>
                    <desc>花蓮縣區域</desc>
                    <path id="C10015" data-name="花蓮縣" d="M335.2,173.5c0.5,1.3,1.1,2.2-0.1,3.6c-2.2,2.5-16.5,18-15.2,25.8c-0.3,3.4-11.2,4.7-2.5,13.5
               ...
               c-0.6-1.5,7,1.4,8.4,3.3C325.3,172,328.8,174.7,335.2,173.5z" style="stroke-dasharray: 497.943, 497.943; stroke-dashoffset: 0;"></path>
                ...
                <a xlink:href="javascript:void(0)" class="">
                  <g >
                    <desc>宜蘭縣區域</desc>
                    <path id="C10002" data-name="宜蘭縣" d="M356.3,77.1c1.5,0.2,3.3,0.5,5.1,0.8c-1.1,0.8-2.2,1.6-3.2,2.1c-3.7,2-9.6,5.1-10.3,10.3
              ...
              <g id="position" transform="translate(180 170)">
                  <g class="icon-in">
                    <desc>座標圖示</desc>
                    <path d="M16,0C9.4,0,4.1,5.3,4.1,11.9S16,32,16,32s11.9-13.5,11.9-20.1C27.9,5.3,22.6,0,16,0z M16,18.7c-3.7,0-6.8-3-6.8-6.8
              s3-6.8,6.8-6.8s6.8,3,6.8,6.8S19.7,18.7,16,18.7z" style="stroke-dasharray: 127.518, 127.518; stroke-dashoffset: 0;"></path>
                    <path d="M20.1,11.9c0,2.2-1.8,4.1-4.1,4.1s-4.1-1.8-4.1-4.1c0-2.2,1.8-4.1,4.1-4.1S20.1,9.7,20.1,11.9z" style="stroke-dasharray: 25.7618, 25.7618; stroke-dashoffset: 0;"></path>
                  </g>
                </g>
...
export default {
   ...
   components:{
    ...
    data() {
        ...
        top:false,
        allCity:{
        台中市:"大雪山國家森林遊樂區，武陵農場，福壽山農場，都會公園",
        南投縣:"小風口，新中橫塔塔加，台大山地實驗農場，鳶峰",
        彰化縣:"八卦山觀景平台，貓頭鷹廣場",
        苗栗縣:"",
        嘉義縣:"對高岳，小笠原觀景台，沼平車站，二萬坪，梅山太興岩步道",
        嘉義市:"",
        雲林縣:"",
        台南市:"",
        高雄市:"",
        ...
        $('#textarea').html(_this.allCity[_this.filter])
        }
        })
