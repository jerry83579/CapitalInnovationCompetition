...
<!-- 導覽行 -->
  ...
  <v-layout style="height:650px">
     ...
     <v-row>  
       ...
       <v-card elevation="20" rounded style="background-color:rgba(0,0,0,0.2);;">
      
      
     
         <h2 class="mt-12 white--text  font-weight-regular">
           觀星氣象大師<br>找出你想去的觀星景點</h2>
     <h3 id="text" class="text-right font-weight-medium white--text"></h3>
       </v-card>
       ...
       <v-col>
       <h6 class="white--text font-weight-medium" style="margin-top:64%" >觀星氣象大師可以找出你想要的觀星景點，<br>天文知識，且讓你知道及時天氣</h6>
       </v-col>
       </v-col>
      ...
      <v-col style="height:500px">
        <svg id="svg" xmlns="http://www.w3.org/2000/svg"  xml:space="preserve" fill="white" >
                <!-- ======================= 基隆市  ======================= -->
                  <g>
                    <desc>基隆市區域</desc>
                    <path id="C10017"  data-name="基隆" @click="jumpPage('Keelung')" d="M315.9,53.9c1.1-0.7,4.2-1.7,7.7-3.2c0.2,0.4,0.4,0.7,0.7,0.9c1.3,1,4,3.1,7.9,4.3c1.2,2.3,0.3,3.6,0.7,6.3
 ...
 <!-- 主要內容 -->
        <v-footer style="background-color:#144552;height:25px">
...
export default {
   ...
   components:{
    ...
    data() {
        ...
        menu: [
        { 
          index: "0", title: "首頁" ,href:"/test"
          },
        {
          index: "1",
          title: "熱門觀星景點",href:"/stargazingSpot"
        },
        {
          index: "2",
          title: "每月天象",href:"/AstronomicalKnowledge"
        },
        {
          index: "3",
          title: "天文影音",href:""
